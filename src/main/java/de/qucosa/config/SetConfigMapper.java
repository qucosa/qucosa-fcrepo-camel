...
public class SetConfigMapper implements Serializable {
    @JsonProperty("sets")
    private List<SetConfigMapper.Set> sets = new ArrayList<>();

    public List<SetConfigMapper.Set> getSets() { return sets; }

    public void setSets(List<SetConfigMapper.Set> sets) { this.sets = sets; }
