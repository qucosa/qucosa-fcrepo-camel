...
public class QucosaElasticSearch extends EndpointDefAbstract implements EndpointDefInterface {
    ...
    public Producer getProducer() {
        return new DefaultProducer(endpoint) {
            ...
            public void process(Exchange exchange) throws Exception {
                System.out.println("QucosaElasticSearch: " + exchange.getIn().getBody());
            }
        };
    }
